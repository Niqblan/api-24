...
export default function Inicio() {
  ...
  const { login, logError } = useContext(Context);
        ...
        <div className="card">
          <div className="card2">
            <form className="form">
              ...
              {logError && <p className="px-10 py-3 border-[2px] border-red-400 text-red-400 rounded-xl mb-2 text-center">Usuario o contraseña incorrectos</p>}
              <div className="field">
